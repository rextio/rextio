...
Rextio **0.1.4** は、plugin API **1.3**、tooling contract **2.2.0** として
2026-07-18 に PyPI 公開された alpha 段階のローカルビルドツールです。
0.1.3 を置き換えます。型付きの
...
0.1.4 で実装済みの native ターゲットは Rust だけです。
...
Rextio 0.1.4 は意図的に小さな subset をサポートします。この subset が
