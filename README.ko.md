...
Rextio **0.1.4**는 plugin API **1.3**, tooling contract **2.2.0**으로
2026-07-18 PyPI에 게시된 alpha 단계 로컬 빌드 도구이며 0.1.3을 대체합니다.
타입이 지정된 Python
...
0.1.4에서 구현된 native target은 Rust뿐입니다.
...
Rextio 0.1.4는 의도적으로 작은 subset을 지원합니다. 이 subset이
