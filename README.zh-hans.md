...
Rextio **0.1.4** 是 alpha 阶段本地构建工具，已于 2026-07-18 发布到 PyPI，
使用 plugin API **1.3** 和 tooling contract **2.2.0**，并取代 0.1.3。
它找出可以安全下沉到 Rust
...
Rextio 0.1.4 刻意支持一个小的 subset。这个 subset 就是以 native
Rust 运行的代码。
