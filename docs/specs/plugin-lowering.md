...
is **2.13.0** because C5.1/C6.1/C6.2/C6.3/C6.4/C6.5/C6.6/C6.7/C6.8 add unrelated external-source
...
and one-hop native path-resolution observation. Plugin API remains **1.4**; C6.4-C6.8 do
