...
tooling contract **2.11.0**, including C6.2 preview evidence, the C6.3
...
C6.6's bounded source-transformation inventory observation, but
...
- Installed pure-Python packages are not recursively promoted, copied, or
  ...
  plugins, or produce signatures. C6.5/C6.6 reports these gaps through a closed,
