...
def generate_rust_crate_module(
    ...
    return _render_importable_crate_module(
        rendered, used_helpers, include_ipc_client=bool(delegated_return_types)
    )
...
def generate_rust_main_binary(
    ...
    """
    crate_source = generate_rust_crate_module(module_ir, delegated_return_types)
...
def _render_importable_crate_module(
    ...
    *,
    ...
    if include_ipc_client:
        lines.append(render_subprocess_client())
        lines.append("")
