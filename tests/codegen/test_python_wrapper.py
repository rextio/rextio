...
""",
    ...
    assert (
        '_REXTIO_NATIVE_TOP_LEVEL_FALLBACK_MODULE_NAME = "_native_top_level_fallback_app"'
        in wrapper
    )
...
def _render_single_function_wrapper(tmp_path: Path, function: FunctionAnalysis) -> str:
