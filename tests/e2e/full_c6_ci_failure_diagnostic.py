...
MACOS_SANDBOX_RESOURCE_FAMILIES = (
    ...
    "private-etc-hosts",
    "private-etc-resolv",
    "private-etc-ssl-root",
    "private-etc-ssl-cert-pem",
    "private-etc-ssl-openssl-cnf",
    "private-etc-ssl-certs-directory",
    "private-etc-ssl-ca-certificates-crt",
    "private-etc-ssl-ca-bundle-pem",
    ...
    "sysctl-kern-iossupportversion",
    "sysctl-kern-osvariant-status",
    "sysctl-kern-other",
    "sysctl-machdep",
